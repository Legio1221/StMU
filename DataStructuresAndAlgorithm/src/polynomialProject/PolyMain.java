...
public class PolyMain {
	...
	public static void main(String[] args) {
		...
		Poly[] p = new Poly[5];
		Poly[] p2 = new Poly[3];
		Poly[] p3 = new Poly[] {new Poly(5,4), new Poly(4,2), new Poly(3,7), new Poly(2, 3), new Poly(1,1), new Poly(14,true)};
		Poly[] p4 = new Poly[] {new Poly(5,1), new Poly(4,2), new Poly(3,5), new Poly(2, 8), new Poly(1,3), new Poly(12,true)};
		Poly[] p5 = new Poly[] {new Poly(2, 3), new Poly(1,-5), new Poly(4,true)};
		Poly[] p6 = new Poly[] {new Poly(5, 1), new Poly(4,-6), new Poly(3,8), new Poly(2,8), new Poly(1,4), new Poly(-40,true)};
		int n;
		int pow;
	...
	static public Poly[] add(Poly[] p, Poly[] p2){
		...
		//Obtains pAdd's length, This loop does not function as intended
