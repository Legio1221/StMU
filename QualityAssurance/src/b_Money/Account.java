...
public class Account {
	private String name; //added the following field.
	 ...
	 */
	public void addTimedPayment(String id, Integer interval, Integer next, Money amount, Account fromAccount, Bank tobank, String toaccount) { 
		TimedPayment tp = new TimedPayment(interval, next, amount, fromAccount, tobank, toaccount); //deleted "this" 
